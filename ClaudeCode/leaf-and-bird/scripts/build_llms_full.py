...
def main():
    lines = [
        ...
        "",
        "> Clean vegan skincare brand making rare non-salmon-derived PDRN serum and whipped grass-fed tallow creams for the ingredient-literate — clean-beauty skeptics who read every label.",
        "",
        "## Brand identity",
